...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v1}, Landroidx/compose/material/SwipeableState;->getAnchors$material_release()Ljava/util/Map;

    move-result-object v1

    .line 594
    .local v1, "oldAnchors":Ljava/util/Map;
    iget-object v2, p0, Landroidx/compose/material/SwipeableKt$swipeable$3$3$1;->$state:Landroidx/compose/material/SwipeableState;

    iget-object v3, p0, Landroidx/compose/material/SwipeableKt$swipeable$3$3$1;->$anchors:Ljava/util/Map;

    invoke-virtual {v2, v3}, Landroidx/compose/material/SwipeableState;->setAnchors$material_release(Ljava/util/Map;)V
    ...
    invoke-virtual {v2, v3}, Landroidx/compose/material/SwipeableState;->setResistance$material_release(Landroidx/compose/material/ResistanceConfig;)V
    ...
    invoke-virtual {v2, v3}, Landroidx/compose/material/SwipeableState;->setThresholds$material_release(Lkotlin/jvm/functions/Function2;)V

    .line 601
    iget-object v2, p0, Landroidx/compose/material/SwipeableKt$swipeable$3$3$1;->$density:Landroidx/compose/ui/unit/Density;
    ...
    .line 601
    .local v5, "$i$a$-with-SwipeableKt$swipeable$3$3$1$2":I
    invoke-interface {v2, v4}, Landroidx/compose/ui/unit/Density;->toPx-0680j_4(F)F

    move-result v4

    invoke-virtual {v3, v4}, Landroidx/compose/material/SwipeableState;->setVelocityThreshold$material_release(F)V

    .line 602
    .end local v2    # "$this$invokeSuspend_u24lambda_u240":Landroidx/compose/ui/unit/Density;
    .end local v5    # "$i$a$-with-SwipeableKt$swipeable$3$3$1$2":I
    iget-object v2, p0, Landroidx/compose/material/SwipeableKt$swipeable$3$3$1;->$state:Landroidx/compose/material/SwipeableState;
    ...
    iput v5, p0, Landroidx/compose/material/SwipeableKt$swipeable$3$3$1;->label:I

    invoke-virtual {v2, v1, v3, v4}, Landroidx/compose/material/SwipeableState;->processNewAnchors$material_release(Ljava/util/Map;Ljava/util/Map;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;

    move-result-object v1

    .end local v1    # "oldAnchors":Ljava/util/Map;
    if-ne v1, v0, :cond_0
