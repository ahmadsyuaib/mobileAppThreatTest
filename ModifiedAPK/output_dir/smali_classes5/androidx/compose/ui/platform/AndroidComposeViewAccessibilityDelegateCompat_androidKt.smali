...
.method static constructor <clinit>()V
    ...
    .line 199
    new-instance v4, Landroidx/compose/ui/platform/AndroidComposeViewAccessibilityDelegateCompat_androidKt$special$$inlined$thenBy$2;

    invoke-direct {v4, v5}, Landroidx/compose/ui/platform/AndroidComposeViewAccessibilityDelegateCompat_androidKt$special$$inlined$thenBy$2;-><init>(Ljava/util/Comparator;)V
...
.method public static final synthetic access$setTraversalValues(Landroidx/collection/IntObjectMap;Landroidx/collection/MutableIntIntMap;Landroidx/collection/MutableIntIntMap;Landroid/content/res/Resources;)V
    .locals 0
    .param p0, "currentSemanticsNodes"    # Landroidx/collection/IntObjectMap;
    .param p1, "outputBeforeMap"    # Landroidx/collection/MutableIntIntMap;
    .param p2, "outputAfterMap"    # Landroidx/collection/MutableIntIntMap;
...
.method private static final createStateDescriptionForTextField(Landroidx/compose/ui/semantics/SemanticsNode;Landroid/content/res/Resources;)Ljava/lang/String;
    ...
    sget v1, Landroidx/compose/ui/R$string;->state_empty:I
...
.method private static final geometryDepthFirstSearch(Landroidx/compose/ui/semantics/SemanticsNode;Ljava/util/ArrayList;Landroidx/collection/MutableIntObjectMap;Landroidx/collection/IntObjectMap;Landroid/content/res/Resources;)V
    .locals 9
    .param p0, "currNode"    # Landroidx/compose/ui/semantics/SemanticsNode;
    .param p1, "geometryList"    # Ljava/util/ArrayList;
    .param p2, "containerMapToChildren"    # Landroidx/collection/MutableIntObjectMap;
    .param p3, "currentSemanticsNodes"    # Landroidx/collection/IntObjectMap;
    ...
    .line 3032
    invoke-static {v0, v3, p3, p4}, Landroidx/compose/ui/platform/AndroidComposeViewAccessibilityDelegateCompat_androidKt;->subtreeSortedByGeometryGrouping(ZLjava/util/List;Landroidx/collection/IntObjectMap;Landroid/content/res/Resources;)Ljava/util/List;

    move-result-object v3

    .line 3031
    invoke-virtual {p2, v2, v3}, Landroidx/collection/MutableIntObjectMap;->set(ILjava/lang/Object;)V
    ...
    .line 3043
    .local v8, "$i$a$-fastForEach-AndroidComposeViewAccessibilityDelegateCompat_androidKt$geometryDepthFirstSearch$1":I
    nop
    ...
    .line 3042
    invoke-static {v7, p1, p2, p3, p4}, Landroidx/compose/ui/platform/AndroidComposeViewAccessibilityDelegateCompat_androidKt;->geometryDepthFirstSearch(Landroidx/compose/ui/semantics/SemanticsNode;Ljava/util/ArrayList;Landroidx/collection/MutableIntObjectMap;Landroidx/collection/IntObjectMap;Landroid/content/res/Resources;)V
    ...
    .end local v8    # "$i$a$-fastForEach-AndroidComposeViewAccessibilityDelegateCompat_androidKt$geometryDepthFirstSearch$1":I
    nop
...
.method private static final getInfoIsCheckable(Landroidx/compose/ui/semantics/SemanticsNode;)Z
    ...
    .line 3249
    .local v4, "$i$a$-let-AndroidComposeViewAccessibilityDelegateCompat_androidKt$getInfoIsCheckable$1":I
    const/4 v0, 0x1

    .line 3251
    .end local v3    # "it":Landroidx/compose/ui/state/ToggleableState;
    .end local v4    # "$i$a$-let-AndroidComposeViewAccessibilityDelegateCompat_androidKt$getInfoIsCheckable$1":I
    :cond_0
    invoke-virtual {p0}, Landroidx/compose/ui/semantics/SemanticsNode;->getUnmergedConfig$ui_release()Landroidx/compose/ui/semantics/SemanticsConfiguration;
    ...
    .line 3252
    .local v4, "$i$a$-let-AndroidComposeViewAccessibilityDelegateCompat_androidKt$getInfoIsCheckable$2":I
    ...
    .line 3251
    .end local v3    # "it":Z
    .end local v4    # "$i$a$-let-AndroidComposeViewAccessibilityDelegateCompat_androidKt$getInfoIsCheckable$2":I
    nop
...
.method private static final getInfoStateDescriptionOrNull(Landroidx/compose/ui/semantics/SemanticsNode;Landroid/content/res/Resources;)Ljava/lang/String;
    ...
    .line 3153
    .local v6, "$i$a$-let-AndroidComposeViewAccessibilityDelegateCompat_androidKt$getInfoStateDescriptionOrNull$1":I
    sget-object v7, Landroidx/compose/ui/platform/AndroidComposeViewAccessibilityDelegateCompat_androidKt$WhenMappings;->$EnumSwitchMapping$0:[I
    ...
    .line 3165
    sget v7, Landroidx/compose/ui/R$string;->state_off:I
    ...
    .line 3158
    sget v7, Landroidx/compose/ui/R$string;->state_on:I
    ...
    .end local v6    # "$i$a$-let-AndroidComposeViewAccessibilityDelegateCompat_androidKt$getInfoStateDescriptionOrNull$1":I
    nop
    ...
    .line 3178
    .local v6, "$i$a$-let-AndroidComposeViewAccessibilityDelegateCompat_androidKt$getInfoStateDescriptionOrNull$2":I
    sget-object v7, Landroidx/compose/ui/semantics/Role;->Companion:Landroidx/compose/ui/semantics/Role$Companion;
    ...
    .line 3177
    .end local v5    # "it":Z
    .end local v6    # "$i$a$-let-AndroidComposeViewAccessibilityDelegateCompat_androidKt$getInfoStateDescriptionOrNull$2":I
    nop
    ...
    .line 3200
    .local v7, "$i$a$-let-AndroidComposeViewAccessibilityDelegateCompat_androidKt$getInfoStateDescriptionOrNull$3":I
    ...
    .line 3217
    .local v4, "percent":I
    sget v9, Landroidx/compose/ui/R$string;->template_percent:I
    ...
    .line 3220
    sget v4, Landroidx/compose/ui/R$string;->in_progress:I
    ...
    .end local v7    # "$i$a$-let-AndroidComposeViewAccessibilityDelegateCompat_androidKt$getInfoStateDescriptionOrNull$3":I
    nop
    ...
    .line 3225
    invoke-static/range {p0 .. p1}, Landroidx/compose/ui/platform/AndroidComposeViewAccessibilityDelegateCompat_androidKt;->createStateDescriptionForTextField(Landroidx/compose/ui/semantics/SemanticsNode;Landroid/content/res/Resources;)Ljava/lang/String;
...
.method private static final setTraversalValues(Landroidx/collection/IntObjectMap;Landroidx/collection/MutableIntIntMap;Landroidx/collection/MutableIntIntMap;Landroid/content/res/Resources;)V
    ...
    .line 2962
    invoke-static {v1, v2, p0, p3}, Landroidx/compose/ui/platform/AndroidComposeViewAccessibilityDelegateCompat_androidKt;->subtreeSortedByGeometryGrouping(ZLjava/util/List;Landroidx/collection/IntObjectMap;Landroid/content/res/Resources;)Ljava/util/List;
    ...
    .line 2974
    .local v6, "currId":I
    invoke-virtual {p1, v5, v6}, Landroidx/collection/MutableIntIntMap;->set(II)V

    .line 2975
    invoke-virtual {p2, v6, v5}, Landroidx/collection/MutableIntIntMap;->set(II)V
...
.method private static final sortByGeometryGroupings(ZLjava/util/ArrayList;Landroid/content/res/Resources;Landroidx/collection/MutableIntObjectMap;)Ljava/util/List;
    .locals 11
    .param p0, "layoutIsRtl"    # Z
    .param p1, "parentListToSort"    # Ljava/util/ArrayList;
    ...
    .line 3075
    .local v0, "rowGroupings":Ljava/util/ArrayList;
    const/4 v1, 0x0
    ...
    .line 3078
    .local v3, "currEntry":Landroidx/compose/ui/semantics/SemanticsNode;
    if-eqz v1, :cond_0

    invoke-static {v0, v3}, Landroidx/compose/ui/platform/AndroidComposeViewAccessibilityDelegateCompat_androidKt;->placedEntryRowOverlaps(Ljava/util/ArrayList;Landroidx/compose/ui/semantics/SemanticsNode;)Z
    ...
    new-array v6, v6, [Landroidx/compose/ui/semantics/SemanticsNode;
    ...
    .line 3075
    .end local v3    # "currEntry":Landroidx/compose/ui/semantics/SemanticsNode;
    ...
    sget-object v2, Landroidx/compose/ui/platform/TopBottomBoundsComparator;->INSTANCE:Landroidx/compose/ui/platform/TopBottomBoundsComparator;
    ...
    .line 3088
    .local v1, "returnList":Ljava/util/ArrayList;
    ...
    .line 3091
    .local v9, "$i$a$-fastForEach-AndroidComposeViewAccessibilityDelegateCompat_androidKt$sortByGeometryGroupings$1":I
    ...
    .end local v9    # "$i$a$-fastForEach-AndroidComposeViewAccessibilityDelegateCompat_androidKt$sortByGeometryGroupings$1":I
    nop
    ...
    sget-object v4, Landroidx/compose/ui/platform/AndroidComposeViewAccessibilityDelegateCompat_androidKt;->UnmergedConfigComparator:Lkotlin/jvm/functions/Function2;

    new-instance v5, Landroidx/compose/ui/platform/AndroidComposeViewAccessibilityDelegateCompat_androidKt$$ExternalSyntheticLambda0;

    invoke-direct {v5, v4}, Landroidx/compose/ui/platform/AndroidComposeViewAccessibilityDelegateCompat_androidKt$$ExternalSyntheticLambda0;-><init>(Lkotlin/jvm/functions/Function2;)V
    ...
    invoke-virtual {p3, v4}, Landroidx/collection/MutableIntObjectMap;->get(I)Ljava/lang/Object;
    ...
    invoke-static {v6, p2}, Landroidx/compose/ui/platform/AndroidComposeViewAccessibilityDelegateCompat_androidKt;->isScreenReaderFocusable(Landroidx/compose/ui/semantics/SemanticsNode;Landroid/content/res/Resources;)Z

    move-result v6

    .line 3108
    .local v6, "containerIsScreenReaderFocusable":Z
    if-nez v6, :cond_4
    ...
    invoke-virtual {v1, v3, v7}, Ljava/util/ArrayList;->addAll(ILjava/util/Collection;)Z
    ...
    .end local v6    # "containerIsScreenReaderFocusable":Z
    goto :goto_2
...
.method private static final subtreeSortedByGeometryGrouping(ZLjava/util/List;Landroidx/collection/IntObjectMap;Landroid/content/res/Resources;)Ljava/util/List;
    .locals 9
    .param p0, "layoutIsRtl"    # Z
    .param p1, "listToSort"    # Ljava/util/List;
    ...
    .line 2999
    .local v8, "$i$a$-fastForEach-AndroidComposeViewAccessibilityDelegateCompat_androidKt$subtreeSortedByGeometryGrouping$1":I
    nop
    ...
    .line 2998
    invoke-static {v7, v1, v0, p2, p3}, Landroidx/compose/ui/platform/AndroidComposeViewAccessibilityDelegateCompat_androidKt;->geometryDepthFirstSearch(Landroidx/compose/ui/semantics/SemanticsNode;Ljava/util/ArrayList;Landroidx/collection/MutableIntObjectMap;Landroidx/collection/IntObjectMap;Landroid/content/res/Resources;)V
    ...
    .end local v8    # "$i$a$-fastForEach-AndroidComposeViewAccessibilityDelegateCompat_androidKt$subtreeSortedByGeometryGrouping$1":I
    nop
